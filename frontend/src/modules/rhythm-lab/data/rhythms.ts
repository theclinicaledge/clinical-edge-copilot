...
export const RHYTHMS: Rhythm[] = [
  ...
  },
  {
    ...
    bedsideRelevance:
      "The rate is rarely the problem — sinus tachycardia is almost always a physiological response to something else. Pain, fever, anxiety, dehydration, bleeding, hypoxia, and medication effects are common drivers. Chasing the rate without finding the cause delays the right response. This is the rhythm where the clinical question is not \"what is the rhythm?\" but \"what is the body reacting to?\"",
    whenMoreUrgent:
  ...
  },
  {
    ...
    confusedWith:
      "SVT with aberrant conduction: also wide and fast, and can look morphologically identical on the strip. The rule that has held for decades: any wide-complex tachycardia with an uncertain origin should be classified as VTach and escalated until definitively proven otherwise. Patient history, hemodynamics, and provider assessment — not strip interpretation alone — determine the next step. Do not delay assessment to debate morphology.",
    bedsideRelevance:
  ...
  },
  {
    ...
    bedsideRelevance:
      "Coarse ventricular fibrillation is cardiac arrest. The ventricles are quivering chaotically with no effective contraction and no cardiac output. Coarse VFib is often seen in earlier or more electrically active arrest states and is generally associated with a shorter time from arrest onset than fine VFib. The amplitude of the fibrillatory waves is not a reliable predictor of outcome — the duration of the arrest and the speed of response are what matter.",
    whenMoreUrgent:
  ...
  },
  {
    ...
    bedsideRelevance:
      "MAT is almost always a sign of significant underlying disease rather than a primary arrhythmia. It is classically associated with severe COPD exacerbation, pulmonary hypertension, heart failure, and critical illness with metabolic derangements including hypomagnesemia and hypokalemia. Addressing the arrhythmia without identifying the underlying cause will not resolve it — the focus is on recognizing hypoxia, identifying electrolyte derangements, and understanding the driving illness. Patients in MAT are usually sick for reasons beyond the rhythm itself.",
    whenMoreUrgent:
  ...
  },
  {
    ...
    recognitionCues: [
      ...
      "Nothing on the strip itself identifies PEA — the diagnosis requires correlating with the patient",
